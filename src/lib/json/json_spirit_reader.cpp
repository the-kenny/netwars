...
namespace
{
    ...
    struct Reader
    {
        ...
        public:
            ...
            Semantic_actions( Value_t& value, bool utf8 )
            :   value_( value )
            ,   current_p_( 0 )
            ,   utf8_( utf8 )
            {
            ...
            void new_name( Iter_t str, Iter_t end )
            {
                ...
                name_ = get_str( str, end, utf8_ );
            }

            void new_str( Iter_t str, Iter_t end )
            {
                add_to_current( get_str( str, end, utf8_ ) );
            }
        ...
        static unsigned hex_to_num( const Char_t c )
        {
        ...
        static unsigned hex_str_to_char( Iter_t& str )
        {
            const Char_t c1( *( ++str ) );
            const Char_t c2( *( ++str ) );
        ...
        static unsigned unicode_str_to_char( Iter_t& str )
        {
            const Char_t c1( *( ++str ) );
            const Char_t c2( *( ++str ) );
            const Char_t c3( *( ++str ) );
        ...
        static String_t substitute_esc_chars( Iter_t str, Iter_t end, bool utf8 )
        {
                ...
                if( ( c1 == '\\' ) && ( i != end_minus_1 ) )
                {
                    ...
                    switch( c2 )
                    {
                        ...
                        case 'x':  
                        {
                            ...
                            {
                                if (utf8)
                                    utf8::append(hex_str_to_char(i), std::back_inserter(result));
                                else
                                    result += Char_t( hex_str_to_char( i ) );
                            }
                            break;
                        }
                        case 'u':  
                        {
                            ...
                            {
                                if (utf8)
                                    utf8::append(unicode_str_to_char(i), std::back_inserter(result));
                                else
                                    result += Char_t( unicode_str_to_char( i ) );
                            }
                            break;
                        }
                    }
        ...
        static String_t get_str( Iter_t str, Iter_t end, bool utf8 )
        {
            assert( end - str >= 2 );
            ...
            return substitute_esc_chars( str_without_quotes, end_without_quotes, utf8 );
        }
        ...
        static bool read_string( const String_t& s, Value_t& value, bool utf8 )
        {
            Semantic_actions semantic_actions( value, utf8 );
        ...
        static bool read_stream( Istream_t& is, Value_t& value, bool utf8 )
        {
            String_t s;

            stream_to_string( is, s );
          
            return read_string( s, value, utf8 );
        }
    };
}

bool json_spirit::read( const std::string& s, Value& value, bool utf8 )
{
    return Reader< Value >::read_string( s, value, utf8 );
}

bool json_spirit::read( std::istream& is, Value& value, bool utf8 )
{
    return Reader< Value >::read_stream( is, value, utf8 );
}
...
{
    return Reader< wValue >::read_string( s, value, false );
}

bool json_spirit::read( std::wistream& is, wValue& value )
{
    return Reader< wValue >::read_stream( is, value, false );
}
